...
export function Profile() {
  ...
  useEffect(()=>{
    getAllFollowers()
    .then((res)=>setFollowers(res.payload as IUser[]))

    getAllFollowings()
    .then(res=>setFollowings(res.payload as IUser[]))
  },[])
  const choosePhoto = () => {
            ...
            <MDBCard>
              ...
              >
                <div className="d-flex justify-content-end text-center py-1">
                  ...
                  <div className="px-3">
                    <MDBCardText className="mb-1 h5">{followers.length}</MDBCardText>
                    <MDBCardText className="small text-muted mb-0">
                      Followers
                    </MDBCardText>
                  </div>
                  <div>
                    <MDBCardText className="mb-1 h5">{followings.length}</MDBCardText>
                    <MDBCardText className="small text-muted mb-0">
                      Following
                    </MDBCardText>
                  </div>
